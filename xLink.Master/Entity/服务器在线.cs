...
namespace xLink.Master.Entity
{
    ...
    [DataObject]
    [Description("服务器在线")]
    [BindIndex("IX_ServerOnline_SessionID", false, "SessionID")]
    [BindIndex("IX_ServerOnline_ServerID", false, "ServerID")]
    [BindIndex("IX_ServerOnline_Name", false, "Name")]
    [BindIndex("IX_ServerOnline_Type", false, "Type")]
    [BindTable("ServerOnline", Description = "服务器在线", ConnName = "ServerOnline", DbType = DatabaseType.SqlServer)]
    public partial class ServerOnline : IServerOnline
    {
        #region 属性
        private Int32 _ID;
        /// <summary>编号</summary>
        ...
        [BindColumn("ServerID", "编码", "int")]
        public Int32 ServerID { get { return _ServerID; } set { if (OnPropertyChanging(__.ServerID, value)) { _ServerID = value; OnPropertyChanged(__.ServerID); } } }
        ...
        #region 字段名
        /// <summary>取得服务器在线字段信息的快捷方式</summary>
        ...
        /// <summary>取得服务器在线字段名称的快捷方式</summary>
    ...
    /// <summary>服务器在线接口</summary>
    public partial interface IServerOnline
    {
        #region 属性
        /// <summary>编号</summary>
        Int32 ID { get; set; }
