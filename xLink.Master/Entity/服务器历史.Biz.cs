...
namespace xLink.Master.Entity
{
    ...
    public partial class ServerHistory : Entity<ServerHistory>
    {
        ...
        /// <returns></returns>
        public static EntityList<ServerHistory> Search(Int32 userid, String type, String action, Int32 result, DateTime start, DateTime end, String key, PageParameter param)
        {
        ...
        private static EntityList<ServerHistory> Search(Int32 tokenid, String type, String action, Int32 result, DateTime start, DateTime end, String key, PageParameter param, Boolean ext)
        {
