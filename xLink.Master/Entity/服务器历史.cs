...
namespace xLink.Master.Entity
{
    ...
    public partial class ServerHistory : IServerHistory
    {
        ...
        [Description("创建者")]
        [DataObjectField(false, false, false, 0)]
        [BindColumn("CreateServerID", "创建者", "int")]
        public Int32 CreateServerID { get { return _CreateServerID; } set { if (OnPropertyChanging(__.CreateServerID, value)) { _CreateServerID = value; OnPropertyChanged(__.CreateServerID); } } }
