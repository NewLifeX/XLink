...
namespace xLink.Master.Entity
{
    ...
    [DataObject]
    [Description("服务器")]
    [BindIndex("IU_Server_Name", true, "Name")]
    [BindIndex("IU_Server_Code", true, "Code")]
    [BindIndex("IX_Server_Type", false, "Type")]
    [BindTable("Server", Description = "服务器", ConnName = "Server", DbType = DatabaseType.SqlServer)]
