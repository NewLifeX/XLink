...
namespace xLink.User.Entity
{
    ...
    public partial class User : Entity<User>
    {
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<User> FindAllByType(String type)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        public static EntityList<User> Search(String type, Boolean? enable, DateTime start, DateTime end, String key, PageParameter param)
        {
