...
namespace xLink.User.Entity
{
    ...
    [BindIndex("IX_UserHistory_Type", false, "Type")]
    [BindTable("UserHistory", Description = "用户历史", ConnName = "UserHistory", DbType = DatabaseType.SqlServer)]
    public partial class UserHistory : IUserHistory
    {
        ...
        [BindColumn(2, "UserID", "编码", null, "int", 10, 0, false)]
