...
namespace xLink.Entity
{
    ...
    [BindTable("DeviceCommand", Description = "设备命令", ConnName = "xLink", DbType = DatabaseType.None)]
    public partial class DeviceCommand : IDeviceCommand
    {
        ...
        #region 字段名
        /// <summary>取得设备命令字段信息的快捷方式</summary>
        ...
        /// <summary>取得设备命令字段名称的快捷方式</summary>
