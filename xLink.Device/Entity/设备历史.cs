...
namespace xLink.Device.Entity
{
    ...
    public partial class DeviceHistory : IDeviceHistory
    {
        ...
        [Description("创建者")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn(8, "CreateDeviceID", "创建者", null, "int", 10, 0, false)]
        public virtual Int32 CreateDeviceID
        {
            get { return _CreateDeviceID; }
            set { if (OnPropertyChanging(__.CreateDeviceID, value)) { _CreateDeviceID = value; OnPropertyChanged(__.CreateDeviceID); } }
        }
